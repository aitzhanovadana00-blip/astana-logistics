  ...
  return (
    <section className="relative min-h-[92vh] overflow-hidden flex items-center justify-center pt-24 pb-24 bg-white dark:bg-[#07101F]">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
        ...
        {/* Display headline */}
        <h1
          className="animate-hero font-headline editorial-spacing leading-[1.02] mb-4"
          style={{
        ...
        {/* Subheadline */}
        <p
          className="animate-hero-delay-1 font-headline mb-8 tracking-tight"
          style={{
        ...
        {/* Description */}
        <p
          className="animate-hero-delay-1 text-base md:text-lg max-w-2xl mx-auto mb-12 leading-relaxed"
        ...
        {/* CTA */}
        <div className="animate-hero-delay-2 flex justify-center">
          <a
            href="#form"
            className="group flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white transition-all hover:shadow-2xl hover:-translate-y-0.5 active:animate-bounce"
            style={{
              background:

...
export default function Contacts() {
  ...
  return (
    <section id="contacts" className="py-20" style={{ background: "var(--bg-card)" }}>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {cards.map((card) => (
            <a
              ...
              className="group card-hover flex flex-col items-center gap-3 rounded-xl p-6 border transition-all duration-300 hover:-translate-y-1 animate-on-scroll"
              style={{
